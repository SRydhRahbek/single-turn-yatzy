...
fn main() {
    ...
    *///PLAYING GAMES
    ...
    println!("{} out of {} games played. Sharing results...\nTime taken: {:?}", i*games_per_update, updates*games_per_update, Instant::now()-t_1);
    ...
    */
    ...
    println!("All done. End time: {:?}\nTotal duration: {:?}\nTime per party: {:?}", end_time, end_time-start_time, (end_time-t_1)/(updates*games_per_update));
